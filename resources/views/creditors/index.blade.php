...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="{{route('addCreditor')}}" class="btn btn-success float-right btn-rounded"><i class="fa fa-plus"></i> Add Creditor</a>
                </div>
            </div>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="/editCreditor/{{$creditor->id}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
{{--                                                <a class="dropdown-item" href="/showEmployee/{{$requisition->id}}"><i class="fa fa-eye m-r-5"></i> Show</a>--}}
                                                <a class="dropdown-item" href="/deleteCreditor/{{$creditor->id}}"><i class="fa fa-trash-o m-r-5 status-red"></i> Delete</a>
