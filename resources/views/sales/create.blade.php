            ...
            <div class="card-box">
                ...
                <form method="post" action="{{route('saveSale')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input id="rate" type="text" class="form-control @error('rate') is-invalid @enderror"
                                   name="rate" value="{{ old('rate') }}" autocomplete="rate" autofocus>
                            @error('rate')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="productTable">
                            ...
                            <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                ...
                                <td><input type="number" min="0" step="0.01" name="ItemQuantity[]"
                                           id="ItemQ<?php echo $x; ?>" class="form-control" required='required'
                                           onkeyup="subAmount()"></td>
                                <td><input type="number" min="0" step="0.01" name="ItemPrice[]"
                                           id="ItemP<?php echo $x; ?>" class="form-control" required='required'
                                           onkeyup="subAmount()"></td>
                                <td>
                                    <button type="button" class="btn btn-success" onclick="addRow()" id="addRowBtn"><i
                                            class="fa fa-plus"></i></button> &nbsp;
                                    <button type="button" class="btn btn-danger removeProductRowBtn"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <button class="btn btn-success form-control" type="submit" onmouseover="subAmount()"
                                    onclick="subAmount()">{{ __('Create Customer Receipt') }}</button>
                        </div>
                    </div>
                </form>
            </div>
