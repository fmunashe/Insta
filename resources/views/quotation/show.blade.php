...
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="page-title"><a href="{{route('quotations')}}" class="btn btn-success btn-rounded pull-right"><i class="fa fa-backward"></i> Back</a> <a href="#" onclick="printQuotation('printable')"><i class="custom-badge status-blue fa fa-print m-r-5">&nbsp Print</i></a></h4>
            </div>
        </div>
                                    ...
                                    <div class="m-b-20">
                                        ...
                                        <div class="table-responsive no-border">
                                            <table class="table mb-0">
                                                ...
                                                <tr>
                                                    <th>Currency:</th>
                                                    <td class="text-right">{{$QuotationDetails->currency}}</td>
                                                </tr>
                                                <tr>
                                                    <th>Sub Total:</th>
                                                ...
                                                <tr>
                                                    <th>Exchange Rate:</th>
                                                    <td class="text-right">{{"X ".$QuotationDetails->rate}}</td>
                                                </tr>
                                                <tr>
