...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="card-title">Upload StockTake Sheet</h4>
                <form method="post" action="{{route('saveStockTake')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label class="col-form-label col-md-2">Choose Stock file</label>
                        <div class="col-md-10">
