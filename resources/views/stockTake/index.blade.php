...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="card-title">Inventory Stock Take<a href="{{route('uploadStockTake')}}"
                                                              class="btn btn-success btn-rounded pull-right"><i
                            class="fa fa-plus"></i> Upload StockTake Sheet</a></h4>
                <table id="client" class="table table-striped table-hover table-condensed">
                    ...
                    @foreach($stocks as $stock)
                        <tr>
                            ...
                            <td>{{$stock->counted_by}}</td>
                            <td>
                                <div class="dropdown dropdown-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
                                       aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="/deleteStockTake/{{$stock->stock_count}}"><i
                                                class="custom-badge status-red fa fa-refresh m-r-5">&nbsp;Rollback Count</i></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
