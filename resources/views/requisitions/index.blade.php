                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="/editRequisition/{{$requisition->id}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
{{--                                                <a class="dropdown-item" href="/showEmployee/{{$requisition->id}}"><i class="fa fa-eye m-r-5"></i> Show</a>--}}
                                                <a class="dropdown-item" href="/deleteEmployee/{{$requisition->id}}"><i class="fa fa-trash-o m-r-5 status-red"></i> Delete</a>
