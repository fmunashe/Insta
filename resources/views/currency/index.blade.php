...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="card-title">Currencies / Modes of Payment<a href="{{route('createCurrency')}}" class="btn btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> New Currency</a></h4>
                <table id="client" class="table table-striped table-hover table-condensed">
                    ...
                    @foreach($currencies as $currency)
                        <tr>
                            ...
                            <td>@if($currency->rate){{$currency->rate->rate}}@endif</td>
        ...
        $(document).ready(function() {
            $('#client').DataTable( {
                ...
                buttons: [
                    ...
                    {
                        extend: 'pdfHtml5',
                        filename: 'Currencies report',
                        title:'All Currencies Report',
                        exportOptions: {
                            columns: [0, 1, 2,3 ]
                        }
                    },
